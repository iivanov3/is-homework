...
namespace TicketsApp.Data.Migrations
{
    ...
    [Migration("20220706115121_RenamedMigration")]
    partial class RenamedMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketsApp.Models.Domain.Order", b =>
                {
                    ...
                    b.HasKey("ShoppingCartId", "AppUserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TicketsApp.Models.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TicketsApp.Models.Domain.Order", b =>
                {
                    b.HasOne("TicketsApp.Models.Identity.AppUser", "AppUser")
                        .WithMany("Orders")
                        .HasForeignKey("AppUserId1");

                    b.HasOne("TicketsApp.Models.Domain.ShoppingCart", "ShoppingCart")
                        .WithMany()
            ...
            modelBuilder.Entity("TicketsApp.Models.Domain.ShoppingCart", b =>
                {
                    b.HasOne("TicketsApp.Models.Identity.AppUser", "Owner")
                        .WithOne("UserCart")
                        .HasForeignKey("TicketsApp.Models.Domain.ShoppingCart", "OwnerId");
                });
